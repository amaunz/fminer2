 ...
 * MyFminer.AddActivity((bool) true, 2);
 * MyFminer.AddActivity((bool) true, 3);
 * MyFminer.AddActivity((bool) true, 4);
 * MyFminer.AddActivity((bool) true, 5);
 * MyFminer.AddActivity((bool) true, 6);
 * MyFminer.AddActivity((bool) true, 7);
 * MyFminer.AddActivity((bool) true, 8);
 * MyFminer.AddActivity((bool) false, 9);
 * MyFminer.AddActivity((bool) false, 10);
