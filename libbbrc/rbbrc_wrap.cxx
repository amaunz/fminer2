...
static swig_class SwigClassBbrc;
...
_wrap_new_Bbrc__SWIG_1(int argc, VALUE *argv, VALUE self) {
  ...
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), Ruby_Format_TypeError( "", "float","Bbrc", 2, argv[1] ));
  } 
...
fail:
  Ruby_Format_OverloadedError( argc, 4, "Bbrc.new", 
    "    Bbrc.new()\n"
    "    Bbrc.new(int _type, float _minfreq)\n"
    "    Bbrc.new(int _type, float _minfreq, float chisq_val, bool _do_backbone)\n");
