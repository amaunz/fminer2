...
#define SWIGTYPE_p_Last swig_types[2]
...
SWIGEXPORT void Init_last(void) {
  ...
  cGC_VALUE.klass = rb_define_class_under(mLast, "GC_VALUE", rb_cObject);
  ...
  cConstIterator.klass = rb_define_class_under(mLast, "ConstIterator", rb_cObject);
  ...
  cIterator.klass = rb_define_class_under(mLast, "Iterator", ((swig_class *) SWIGTYPE_p_swig__ConstIterator->clientdata)->klass);
  ...
  cSVector.klass = rb_define_class_under(mLast, "SVector", rb_cObject);
  ...
  rb_define_alloc_func(cLast.klass, _wrap_Last_allocate);
  rb_define_method(cLast.klass, "initialize", VALUEFUNC(_wrap_new_Last), -1);
  rb_define_method(cLast.klass, "Reset", VALUEFUNC(_wrap_Last_Reset), -1);
  rb_define_method(cLast.klass, "Defaults", VALUEFUNC(_wrap_Last_Defaults), -1);
  rb_define_method(cLast.klass, "GetMinfreq", VALUEFUNC(_wrap_Last_GetMinfreq), -1);
  rb_define_method(cLast.klass, "GetType", VALUEFUNC(_wrap_Last_GetType), -1);
  rb_define_method(cLast.klass, "GetBackbone", VALUEFUNC(_wrap_Last_GetBackbone), -1);
  rb_define_method(cLast.klass, "GetDynamicUpperBound", VALUEFUNC(_wrap_Last_GetDynamicUpperBound), -1);
  rb_define_method(cLast.klass, "GetPruning", VALUEFUNC(_wrap_Last_GetPruning), -1);
  rb_define_method(cLast.klass, "GetConsoleOut", VALUEFUNC(_wrap_Last_GetConsoleOut), -1);
  rb_define_method(cLast.klass, "GetAromatic", VALUEFUNC(_wrap_Last_GetAromatic), -1);
  ...
  rb_define_method(cLast.klass, "SetBackbone", VALUEFUNC(_wrap_Last_SetBackbone), -1);
  rb_define_method(cLast.klass, "SetDynamicUpperBound", VALUEFUNC(_wrap_Last_SetDynamicUpperBound), -1);
  rb_define_method(cLast.klass, "SetPruning", VALUEFUNC(_wrap_Last_SetPruning), -1);
  rb_define_method(cLast.klass, "SetConsoleOut", VALUEFUNC(_wrap_Last_SetConsoleOut), -1);
  rb_define_method(cLast.klass, "SetAromatic", VALUEFUNC(_wrap_Last_SetAromatic), -1);
  ...
  rb_define_method(cLast.klass, "AddCompound", VALUEFUNC(_wrap_Last_AddCompound), -1);
  rb_define_method(cLast.klass, "AddActivity", VALUEFUNC(_wrap_Last_AddActivity), -1);
  rb_define_method(cLast.klass, "GetNoRootNodes", VALUEFUNC(_wrap_Last_GetNoRootNodes), -1);
  rb_define_method(cLast.klass, "GetNoCompounds", VALUEFUNC(_wrap_Last_GetNoCompounds), -1);
  cLast.mark = 0;
  cLast.destroy = (void (*)(void *)) free_Last;
  cLast.trackObjects = 0;
}
