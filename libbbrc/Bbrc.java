...
public class Bbrc {
  ...
  public Bbrc(int _type, float _minfreq) {
    this(libbbrcJNI.new_Bbrc__SWIG_1(_type, _minfreq), true);
  }

  public Bbrc(int _type, float _minfreq, float chisq_val, boolean _do_backbone) {
  ...
  public void SetMinfreq(float val) {
  ...
  public boolean AddWeight(float weight, long comp_id) {
    return libbbrcJNI.Bbrc_AddWeight(swigCPtr, this, weight, comp_id);
  }
