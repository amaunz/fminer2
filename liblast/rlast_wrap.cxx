...
SWIGINTERN VALUE std_vector_Sl_float_Sg__inspect(std::vector< float > *self){
      ...
      const char *type_name = swig::type_name< std::vector<float,std::allocator< float > > >();
      VALUE str = rb_str_new2(type_name);
      str = rb_str_cat2( str, " [" );
      bool comma = false;
      VALUE tmp;
...
static swig_class SwigClassFVector;
...
/*
  ...
  call-seq:
    push(e) -> std::vector< float >::value_type const
...
_wrap_FVector_get_allocator(int argc, VALUE *argv, VALUE self) {
  ...
  vresult = SWIG_NewPointerObj((new std::vector< float >::allocator_type(static_cast< const std::vector< float >::allocator_type& >(result))), SWIGTYPE_p_std__allocatorT_float_t, SWIG_POINTER_OWN |  0 );
  return vresult;
fail:
  return Qnil;
}
...
/*
  ...
  call-seq:
    begin -> std::vector< float >::iterator
...
_wrap_FVector_begin(int argc, VALUE *argv, VALUE self) {
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__vectorT_float_std__allocatorT_float_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::vector< float > *","begin", 1, self )); 
  }
  arg1 = reinterpret_cast< std::vector< float > * >(argp1);
  result = (arg1)->begin();
...
_wrap_FVector_end(int argc, VALUE *argv, VALUE self) {
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__vectorT_float_std__allocatorT_float_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::vector< float > *","end", 1, self )); 
  }
  arg1 = reinterpret_cast< std::vector< float > * >(argp1);
  result = (arg1)->end();
  vresult = SWIG_NewPointerObj(swig::make_nonconst_iterator(static_cast< const std::vector< float >::iterator & >(result),
...
/*
  ...
  call-seq:
    rbegin -> std::vector< float >::reverse_iterator
...
_wrap_FVector_rbegin(int argc, VALUE *argv, VALUE self) {
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__vectorT_float_std__allocatorT_float_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::vector< float > *","rbegin", 1, self )); 
  }
  arg1 = reinterpret_cast< std::vector< float > * >(argp1);
  result = (arg1)->rbegin();
  vresult = SWIG_NewPointerObj(swig::make_nonconst_iterator(static_cast< const std::vector< float >::reverse_iterator & >(result),
      self),
    swig::Iterator::descriptor(),SWIG_POINTER_OWN);
  return vresult;
fail:
...
/*
  ...
  call-seq:
    rend -> std::vector< float >::reverse_iterator
...
_wrap_FVector_rend(int argc, VALUE *argv, VALUE self) {
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_std__vectorT_float_std__allocatorT_float_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::vector< float > *","rend", 1, self )); 
  }
  arg1 = reinterpret_cast< std::vector< float > * >(argp1);
  result = (arg1)->rend();
  vresult = SWIG_NewPointerObj(swig::make_nonconst_iterator(static_cast< const std::vector< float >::reverse_iterator & >(result),
...
/*
  ...
  call-seq:
    ...
    erase(first, last) -> std::vector< float >::iterator
...
/*
  ...
  call-seq:
    front -> std::vector< float >::value_type const &
...
/*
  ...
  call-seq:
    back -> std::vector< float >::value_type const &
...
/*
  ...
  call-seq:
    capacity -> std::vector< float >::size_type
...
_wrap_Last_SetMinfreq(int argc, VALUE *argv, VALUE self) {
  ...
  ecode2 = SWIG_AsVal_float(argv[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), Ruby_Format_TypeError( "", "float","SetMinfreq", 2, argv[0] ));
  } 
...
_wrap_Last_ChisqTest(int argc, VALUE *argv, VALUE self) {
  ...
  arg1 = reinterpret_cast< Last * >(argp1);
  {
    ...
    if (!SWIG_IsOK(res) || !ptr) {
      SWIG_exception_fail(SWIG_ArgError((ptr ? res : SWIG_TypeError)), Ruby_Format_TypeError( "", "std::vector< float >","ChisqTest", 2, argv[0] )); 
    }
    arg2 = *ptr;
    if (SWIG_IsNewObj(res)) delete ptr;
  }
  {
    ...
    if (!SWIG_IsOK(res) || !ptr) {
      SWIG_exception_fail(SWIG_ArgError((ptr ? res : SWIG_TypeError)), Ruby_Format_TypeError( "", "std::vector< float >","ChisqTest", 3, argv[1] )); 
    }
    arg3 = *ptr;
    if (SWIG_IsNewObj(res)) delete ptr;
  }
