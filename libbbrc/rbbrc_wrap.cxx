...
SWIGINTERN VALUE
_wrap_bbrc_adjust_ub_get(VALUE self) {
  VALUE _val;
  
  _val = SWIG_From_bool(static_cast< bool >(fm::bbrc_adjust_ub));
  return _val;
}


SWIGINTERN VALUE
_wrap_bbrc_adjust_ub_set(VALUE self, VALUE _val) {
  {
    bool val;
...
SWIGINTERN VALUE
_wrap_bbrc_do_pruning_get(VALUE self) {
  VALUE _val;
  
  _val = SWIG_From_bool(static_cast< bool >(fm::bbrc_do_pruning));
  return _val;
}


SWIGINTERN VALUE
_wrap_bbrc_do_pruning_set(VALUE self, VALUE _val) {
  {
    bool val;
    int res = SWIG_AsVal_bool(_val, &val);
    if (!SWIG_IsOK(res)) {
...
SWIGINTERN VALUE
_wrap_bbrc_aromatic_get(VALUE self) {
  VALUE _val;
  
  _val = SWIG_From_bool(static_cast< bool >(fm::bbrc_aromatic));
  return _val;
}


SWIGINTERN VALUE
_wrap_bbrc_aromatic_set(VALUE self, VALUE _val) {
  {
    bool val;
    int res = SWIG_AsVal_bool(_val, &val);
    if (!SWIG_IsOK(res)) {
...
SWIGINTERN VALUE
_wrap_bbrc_do_yaml_get(VALUE self) {
  VALUE _val;
  
  _val = SWIG_From_bool(static_cast< bool >(fm::bbrc_do_yaml));
  return _val;
}


SWIGINTERN VALUE
_wrap_bbrc_do_yaml_set(VALUE self, VALUE _val) {
  {
    bool val;
    int res = SWIG_AsVal_bool(_val, &val);
    if (!SWIG_IsOK(res)) {
...
SWIGINTERN VALUE
_wrap_bbrc_gsp_out_get(VALUE self) {
  VALUE _val;
  
  _val = SWIG_From_bool(static_cast< bool >(fm::bbrc_gsp_out));
  return _val;
}


SWIGINTERN VALUE
_wrap_bbrc_gsp_out_set(VALUE self, VALUE _val) {
  {
    bool val;
    int res = SWIG_AsVal_bool(_val, &val);
    if (!SWIG_IsOK(res)) {
...
SWIGINTERN VALUE
_wrap_bbrc_bbrc_sep_get(VALUE self) {
  VALUE _val;
  
  _val = SWIG_From_bool(static_cast< bool >(fm::bbrc_bbrc_sep));
  return _val;
}


SWIGINTERN VALUE
_wrap_bbrc_bbrc_sep_set(VALUE self, VALUE _val) {
  {
    bool val;
    int res = SWIG_AsVal_bool(_val, &val);
    if (!SWIG_IsOK(res)) {
...
SWIGINTERN VALUE
_wrap_bbrc_regression_get(VALUE self) {
  VALUE _val;
  
  _val = SWIG_From_bool(static_cast< bool >(fm::bbrc_regression));
  return _val;
}


SWIGINTERN VALUE
_wrap_bbrc_regression_set(VALUE self, VALUE _val) {
  {
    bool val;
    int res = SWIG_AsVal_bool(_val, &val);
    if (!SWIG_IsOK(res)) {
...
SWIGINTERN VALUE
_wrap_bbrc_db_built_get(VALUE self) {
  VALUE _val;
  
  _val = SWIG_From_bool(static_cast< bool >(fm::bbrc_db_built));
  return _val;
}


SWIGINTERN VALUE
_wrap_bbrc_db_built_set(VALUE self, VALUE _val) {
  {
    bool val;
    int res = SWIG_AsVal_bool(_val, &val);
    if (!SWIG_IsOK(res)) {
...
SWIGINTERN VALUE
_wrap_Bbrc_SetMaxHops(int argc, VALUE *argv, VALUE self) {
  Bbrc *arg1 = (Bbrc *) 0 ;
  int arg2 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_Bbrc, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "Bbrc *","SetMaxHops", 1, self )); 
  }
  arg1 = reinterpret_cast< Bbrc * >(argp1);
  ecode2 = SWIG_AsVal_int(argv[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
...
SWIGEXPORT void Init_bbrc(void) {
  ...
  SwigClassGC_VALUE.klass = rb_define_class_under(mBbrc, "GC_VALUE", rb_cObject);
  ...
  SwigClassConstIterator.klass = rb_define_class_under(mBbrc, "ConstIterator", rb_cObject);
  ...
  SwigClassIterator.klass = rb_define_class_under(mBbrc, "Iterator", ((swig_class *) SWIGTYPE_p_swig__ConstIterator->clientdata)->klass);
  ...
  SwigClassSVector.klass = rb_define_class_under(mBbrc, "SVector", rb_cObject);
  ...
  rb_define_singleton_method(mBbrc, "bbrc_adjust_ub", VALUEFUNC(_wrap_bbrc_adjust_ub_get), 0);
  rb_define_singleton_method(mBbrc, "bbrc_adjust_ub=", VALUEFUNC(_wrap_bbrc_adjust_ub_set), 1);
  rb_define_singleton_method(mBbrc, "bbrc_do_pruning", VALUEFUNC(_wrap_bbrc_do_pruning_get), 0);
  rb_define_singleton_method(mBbrc, "bbrc_do_pruning=", VALUEFUNC(_wrap_bbrc_do_pruning_set), 1);
  rb_define_singleton_method(mBbrc, "bbrc_aromatic", VALUEFUNC(_wrap_bbrc_aromatic_get), 0);
  rb_define_singleton_method(mBbrc, "bbrc_aromatic=", VALUEFUNC(_wrap_bbrc_aromatic_set), 1);
  rb_define_singleton_method(mBbrc, "bbrc_chisq", VALUEFUNC(_wrap_bbrc_chisq_get), 0);
  rb_define_singleton_method(mBbrc, "bbrc_chisq=", VALUEFUNC(_wrap_bbrc_chisq_set), 1);
  rb_define_singleton_method(mBbrc, "bbrc_ks", VALUEFUNC(_wrap_bbrc_ks_get), 0);
  rb_define_singleton_method(mBbrc, "bbrc_ks=", VALUEFUNC(_wrap_bbrc_ks_set), 1);
  rb_define_singleton_method(mBbrc, "bbrc_do_yaml", VALUEFUNC(_wrap_bbrc_do_yaml_get), 0);
  rb_define_singleton_method(mBbrc, "bbrc_do_yaml=", VALUEFUNC(_wrap_bbrc_do_yaml_set), 1);
  rb_define_singleton_method(mBbrc, "bbrc_gsp_out", VALUEFUNC(_wrap_bbrc_gsp_out_get), 0);
  rb_define_singleton_method(mBbrc, "bbrc_gsp_out=", VALUEFUNC(_wrap_bbrc_gsp_out_set), 1);
  rb_define_singleton_method(mBbrc, "bbrc_bbrc_sep", VALUEFUNC(_wrap_bbrc_bbrc_sep_get), 0);
  rb_define_singleton_method(mBbrc, "bbrc_bbrc_sep=", VALUEFUNC(_wrap_bbrc_bbrc_sep_set), 1);
  rb_define_singleton_method(mBbrc, "bbrc_regression", VALUEFUNC(_wrap_bbrc_regression_get), 0);
  rb_define_singleton_method(mBbrc, "bbrc_regression=", VALUEFUNC(_wrap_bbrc_regression_set), 1);
  rb_define_singleton_method(mBbrc, "bbrc_db_built", VALUEFUNC(_wrap_bbrc_db_built_get), 0);
  rb_define_singleton_method(mBbrc, "bbrc_db_built=", VALUEFUNC(_wrap_bbrc_db_built_set), 1);
  
  SwigClassBbrc.klass = rb_define_class_under(mBbrc, "Bbrc", rb_cObject);
  SWIG_TypeClientData(SWIGTYPE_p_Bbrc, (void *) &SwigClassBbrc);
  rb_define_alloc_func(SwigClassBbrc.klass, _wrap_Bbrc_allocate);
  rb_define_method(SwigClassBbrc.klass, "initialize", VALUEFUNC(_wrap_new_Bbrc), -1);
  rb_define_method(SwigClassBbrc.klass, "Reset", VALUEFUNC(_wrap_Bbrc_Reset), -1);
  rb_define_method(SwigClassBbrc.klass, "Defaults", VALUEFUNC(_wrap_Bbrc_Defaults), -1);
  rb_define_method(SwigClassBbrc.klass, "GetMinfreq", VALUEFUNC(_wrap_Bbrc_GetMinfreq), -1);
  rb_define_method(SwigClassBbrc.klass, "GetType", VALUEFUNC(_wrap_Bbrc_GetType), -1);
  rb_define_method(SwigClassBbrc.klass, "GetBackbone", VALUEFUNC(_wrap_Bbrc_GetBackbone), -1);
  rb_define_method(SwigClassBbrc.klass, "GetDynamicUpperBound", VALUEFUNC(_wrap_Bbrc_GetDynamicUpperBound), -1);
  rb_define_method(SwigClassBbrc.klass, "GetPruning", VALUEFUNC(_wrap_Bbrc_GetPruning), -1);
  rb_define_method(SwigClassBbrc.klass, "GetConsoleOut", VALUEFUNC(_wrap_Bbrc_GetConsoleOut), -1);
  rb_define_method(SwigClassBbrc.klass, "GetAromatic", VALUEFUNC(_wrap_Bbrc_GetAromatic), -1);
  rb_define_method(SwigClassBbrc.klass, "GetRefineSingles", VALUEFUNC(_wrap_Bbrc_GetRefineSingles), -1);
  rb_define_method(SwigClassBbrc.klass, "GetDoOutput", VALUEFUNC(_wrap_Bbrc_GetDoOutput), -1);
  rb_define_method(SwigClassBbrc.klass, "GetBbrcSep", VALUEFUNC(_wrap_Bbrc_GetBbrcSep), -1);
  rb_define_method(SwigClassBbrc.klass, "GetChisqActive", VALUEFUNC(_wrap_Bbrc_GetChisqActive), -1);
  rb_define_method(SwigClassBbrc.klass, "GetChisqSig", VALUEFUNC(_wrap_Bbrc_GetChisqSig), -1);
  rb_define_method(SwigClassBbrc.klass, "GetRegression", VALUEFUNC(_wrap_Bbrc_GetRegression), -1);
  rb_define_method(SwigClassBbrc.klass, "SetMinfreq", VALUEFUNC(_wrap_Bbrc_SetMinfreq), -1);
  rb_define_method(SwigClassBbrc.klass, "SetType", VALUEFUNC(_wrap_Bbrc_SetType), -1);
  rb_define_method(SwigClassBbrc.klass, "SetBackbone", VALUEFUNC(_wrap_Bbrc_SetBackbone), -1);
  rb_define_method(SwigClassBbrc.klass, "SetDynamicUpperBound", VALUEFUNC(_wrap_Bbrc_SetDynamicUpperBound), -1);
  rb_define_method(SwigClassBbrc.klass, "SetPruning", VALUEFUNC(_wrap_Bbrc_SetPruning), -1);
  rb_define_method(SwigClassBbrc.klass, "SetConsoleOut", VALUEFUNC(_wrap_Bbrc_SetConsoleOut), -1);
  rb_define_method(SwigClassBbrc.klass, "SetAromatic", VALUEFUNC(_wrap_Bbrc_SetAromatic), -1);
  rb_define_method(SwigClassBbrc.klass, "SetRefineSingles", VALUEFUNC(_wrap_Bbrc_SetRefineSingles), -1);
  rb_define_method(SwigClassBbrc.klass, "SetDoOutput", VALUEFUNC(_wrap_Bbrc_SetDoOutput), -1);
  rb_define_method(SwigClassBbrc.klass, "SetBbrcSep", VALUEFUNC(_wrap_Bbrc_SetBbrcSep), -1);
  rb_define_method(SwigClassBbrc.klass, "SetChisqActive", VALUEFUNC(_wrap_Bbrc_SetChisqActive), -1);
  rb_define_method(SwigClassBbrc.klass, "SetChisqSig", VALUEFUNC(_wrap_Bbrc_SetChisqSig), -1);
  rb_define_method(SwigClassBbrc.klass, "SetRegression", VALUEFUNC(_wrap_Bbrc_SetRegression), -1);
  rb_define_method(SwigClassBbrc.klass, "SetMaxHops", VALUEFUNC(_wrap_Bbrc_SetMaxHops), -1);
  rb_define_method(SwigClassBbrc.klass, "MineRoot", VALUEFUNC(_wrap_Bbrc_MineRoot), -1);
  ...
  SwigClassBbrc.destroy = (void (*)(void *)) free_Bbrc;
  SwigClassBbrc.trackObjects = 0;
}
